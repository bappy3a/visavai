                                       ...
                                       <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                 ...
                                                 <div class="input-group">
                                                      <input type="text" class="form-control" id="slug" name="slug" value="{{ old('slug') }}" placeholder="Auto-generated from title" readonly>
                                            ...
                                            <div class="mb-3">
                                                 ...
                                                 <textarea class="form-control" id="excerpt" name="excerpt" rows="3" placeholder="Short description of the blog">{{ old('excerpt') }}</textarea>
                                            ...
                                            <div class="mb-3">
                                                 ...
                                                 <div id="snow-editor" style="min-height: 300px; background: white;">{!! old('content') !!}</div>
                                            ...
                                            <div class="mb-3">
                                                 ...
                                                 <small class="text-muted">Upload an image file (JPG, PNG, GIF, WEBP)</small>
                                            </div>
                                       </div>
                                  </div>
                                  ...
                                  <div class="card">
                                       ...
                                       <div class="card-body">
                                            <div class="mb-3">
                                                 ...
                                                 <input type="text" class="form-control" id="meta_title" name="meta_title" value="{{ old('meta_title') }}" placeholder="SEO title for search engines">
                                            </div>
                                            <div class="mb-3">
                                                 <label for="meta_description" class="form-label">Meta Description</label>
                                                 <textarea class="form-control" id="meta_description" name="meta_description" rows="3" placeholder="SEO description for search engines">{{ old('meta_description') }}</textarea>
                                            </div>
                                            <div class="mb-3">
...
<script>
     ...
     function updateImagePreview(source) {
          ...
          if (source instanceof File) {
               ...
               imagePreview.innerHTML = `<img src="${source}" alt="Featured Image" class="img-fluid rounded" style="max-height: 300px;" onerror="this.parentElement.innerHTML='<p class=\'text-danger mb-0\'>Invalid image URL</p>'">`;
          } else {
